...
export async function GET(request: NextRequest) {
    try {
        ...
        try {
            ...
            console.warn("Failed to set session timezone", e);
        }
        ...
        try {
            ...
            const schedules = result.rows.map((row) => {
                ...
                // Format as IST string explicitly
                ...
                return {
                    ...
                    status: obj.STATUS,
                    nextRunAt: obj.NEXT_RUN_AT, // Return raw ISO for potential client use
                    lastRunAt: obj.LAST_RUN_AT,
                    createdBy: obj.CREATED_BY,
                    createdAt: obj.CREATED_AT,
                    nextRunFormatted: formatIST(obj.NEXT_RUN_AT),
                    lastRunFormatted: formatIST(obj.LAST_RUN_AT) // Add this for UI usage
                };
            });
