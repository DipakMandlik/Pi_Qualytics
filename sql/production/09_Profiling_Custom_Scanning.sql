...
HANDLER = 'main'
EXECUTE AS CALLER
COMMENT = 'Profile a single dataset with all configured rules - generates complete metrics'
AS
$$
...
HANDLER = 'main'
EXECUTE AS CALLER
COMMENT = 'Run a single rule ad-hoc with optional threshold override - supports ADHOC mode without config mapping'
AS
$$
import snowflake.snowpark as snowpark
from snowflake.snowpark import Session
