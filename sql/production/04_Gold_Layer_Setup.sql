...
COMMENT = 'Gold - Customer 360 view with account and transaction metrics';
...
COMMENT = 'Gold - Customer segmentation based on transaction volume and activity';
...
COMMENT = 'Gold - Account summary with transaction and balance metrics';
...
COMMENT = 'Gold - Daily transaction summary by type';
...
COMMENT = 'Gold - Monthly transaction trends and patterns';
...
COMMENT = 'Gold - Data quality scorecard across all entities';
...
COMMENT = 'Gold - All data quality issues across entities';
...
COMMENT = 'Gold - Executive dashboard with key business and DQ metrics';
