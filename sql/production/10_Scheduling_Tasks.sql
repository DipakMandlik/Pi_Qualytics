...
HANDLER = 'main'
EXECUTE AS CALLER
COMMENT = 'Profile a dataset - generates column statistics and synthetic quality checks'
AS
$$
...
HANDLER = 'main'
EXECUTE AS CALLER
COMMENT = 'Run custom checks for a dataset - supports selective rule filtering via JSON config'
AS
$$
import snowflake.snowpark as snowpark
import json
...
HANDLER = 'main'
EXECUTE AS CALLER
COMMENT = 'Main scheduler processor - checks for due schedules and executes them'
AS
$$
import snowflake.snowpark as snowpark
