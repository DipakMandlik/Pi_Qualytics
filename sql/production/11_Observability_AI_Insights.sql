...
LANGUAGE SQL
EXECUTE AS CALLER
COMMENT = 'Safely ingest a new metric into DQ_METRICS with validation'
AS
$$
BEGIN
...
LANGUAGE SQL
EXECUTE AS CALLER
COMMENT = 'Backfill DQ_METRICS from existing DQ_CHECK_RESULTS, DQ_COLUMN_PROFILE, and DQ_DAILY_SUMMARY'
AS
$$
BEGIN
...
HANDLER = 'main'
EXECUTE AS CALLER
COMMENT = 'Generate AI-driven insights from DQ_METRICS - analyzes trends, anomalies, and quality patterns'
AS
$$
